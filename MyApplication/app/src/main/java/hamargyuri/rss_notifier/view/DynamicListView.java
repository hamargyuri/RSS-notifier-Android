...
public class DynamicListView extends ListView {
    ...
    private AdapterView.OnItemLongClickListener mOnItemLongClickListener =
            new AdapterView.OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                    ...
                    ((FeedListActivity)getContext()).setDisableSwipeRefresh(true);
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        FeedAdapter adapter = ((FeedAdapter) getAdapter());
    ...
    public boolean dispatchTouchEvent (MotionEvent event) {
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ((FeedListActivity)getContext()).setDisableSwipeRefresh(false);
    ...
    private void swapElements(ArrayList<Feed> arrayList, int indexOne, int indexTwo) {
